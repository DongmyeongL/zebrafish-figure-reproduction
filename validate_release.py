...
EXPECTED_FIGURES = [
    ...
    "figure12_final_v3_fcs_calibrated_skeleton_kmeans_nearest_r12.png",
    "figure13_final_v2.png",
    "figure_fcv_fcs_fu_sc_corr_forest_fcs_calibrated_skeleton_kmeans_nearest_r12_two_way_subsampling.png",
    "figure_invertebrate_oo_fcv_relationships_with_137_subunits.png",
    "figure_stimulus_delta_fcv_acd_combined_skeleton_kmeans_nearest_r12_two_way_subsampling.png",
    "figure_invertebrate_anatomical_group_summary.png",
    "figure_invertebrate_multiscale_sc_fc_matrices.png",
